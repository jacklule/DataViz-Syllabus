...
<li><a href="http://jacklule.github.io/Insert%image%test.html/">Finally we will learn how to upload a chart to GitHub and display it on our GitHub pages: 1) Create chart in Chartbuilder; 2) Export or Save as PNG or SVG to local computer; 3) Put file in local github.io folder; 4) Commit and Sync with GitHub site; 5) When placing link on display page, don't forget http://</a></li>
