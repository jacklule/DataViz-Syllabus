...
<p>1) Using data from Lehigh's [Fall 2015 institutional profile](http://www.lehigh.edu/~oir/profiles/profile_files/LUprofile_2015.pdf), create a chart in Chartbuilder that shows the percentage of undergraduate enrollment per college. Check [Anantomy of a Chart](<li><a href="http://www.lamivo.com/tipsheets/anatomy_chart.pdf">Anatomy of a Chart</a>: one-page handout</li>) to make sure you have the essential elements. </p>
