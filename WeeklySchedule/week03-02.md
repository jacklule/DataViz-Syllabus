...
If time permits: Intro to CSS (Cascading Style Sheets in html)
...
- Your spreadsheet in Google docs should have four columns: Year, Arts & Sciences, Business and Engineering.
- Copy that spreadsheet and create a column bar chart in Chartbuilder that shows the percentage of undergraduate enrollment per college per year. 
http://www.lehigh.edu/~oir/profiles/profile.htm
