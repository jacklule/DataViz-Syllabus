...
See [class GitHub Setup Guide](https://github.com/jacklule/DataViz-Syllabus/blob/master/GitHubSetUp.md), scroll down to Day 2
...
###Assignments: Customize the GitHub Page (also at GitHub Setup Page)
