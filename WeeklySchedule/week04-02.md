...
- Open Google Fusion tutorial; we will first review and then substitute [spreadsheet on local arts centers](https://docs.google.com/spreadsheets/d/1JGp-6voHfeLbywHQb7jifRpXX6AuIlYE-A8HNE1gdHc/edit?usp=sharing)
...
- click in Location cell for dropdown menu. click Change. Change Type from Text to Location. Repeat steps with Name cell. Change from Location to Text.
