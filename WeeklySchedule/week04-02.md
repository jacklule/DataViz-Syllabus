...
- Review spreadsheet at Google Docs
- Demonstrate how to get images from Google: Search>Images>View Image (get photo credit)
- Open Google Fusion tutorial and substitute [spreadsheet on local arts centers](https://docs.google.com/spreadsheets/d/1JGp-6voHfeLbywHQb7jifRpXX6AuIlYE-A8HNE1gdHc/edit?usp=sharing)
